//===--- Tricore.h - Tricore Tool and ToolChain Implementations ---------*- C++ -*-===//
//
...
public:
  ...
  std::optional<std::string> findTricoreLibcInstallation() const;
...
public:
  Linker(const llvm::Triple &Triple, const ToolChain &TC)
      : Tool("Tricore::Linker", "tricore-ld", TC), Triple(Triple) {}
